        ...
        <div class="card">
                    ...
                    <div class="col-9">
                        <div class="form-group">
                            ...
                            <textarea
                                    ...
                                    name="description"
                                    id="description">{!! old('description', $logicalServer->description) !!}</textarea>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="iconSelect"
                                    ...
                                    data-selected="{{ $logicalServer->icon_id ?? '-1' }}"
                                    data-default-img="{{ asset('images/lserver.png') }}"
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('address_ip') ? 'is-invalid' : '' }}" type="text"
                                   ...
                                   value="{{ old('address_ip', $logicalServer->address_ip) }}">
                ...
                @can('backup_access')
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="backup_ids">{{ trans('cruds.logicalServer.fields.backups') }}</label>
                                <select class="form-control select2 {{ $errors->has('backup_ids') ? 'is-invalid' : '' }}"
                                        name="backup_ids[]" id="backup_ids" multiple>
                                    @foreach($backups as $id => $name)
                                        <option value="{{ $id }}"
                                            {{ (in_array($id, old('backup_ids', [])) || $logicalServer->backups->contains($id)) ? 'selected' : '' }}>
                                            {{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                                @if($errors->has('backup_ids'))
                                    <div class="invalid-feedback">{{ $errors->first('backup_ids') }}</div>
                                @endif
                                <span class="help-block">{{ trans('cruds.logicalServer.fields.backups_helper') }}</span>
                            </div>
                        </div>
                @endcan
                    </div>
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('cpu') ? 'is-invalid' : '' }}" type="text"
                                   name="cpu" id="cpu" value="{{ old('cpu', $logicalServer->cpu) }}">
                            @if($errors->has('cpu'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cpu') }}
                                </div>
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('memory') ? 'is-invalid' : '' }}" type="text"
                                   name="memory" id="memory" value="{{ old('memory', $logicalServer->memory) }}">
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('disk') ? 'is-invalid' : '' }}" type="text"
                                   name="disk" id="disk" value="{{ old('disk', $logicalServer->disk) }}">
                            @if($errors->has('disk'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('disk') }}
                                </div>
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('disk_used') ? 'is-invalid' : '' }}" type="text"
                                   name="disk_used" id="disk_used"
                                   value="{{ old('disk_used', $logicalServer->disk_used) }}">
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            <textarea
                                    ...
                                    name="configuration"
                                    id="configuration">{!! old('configuration', $logicalServer->configuration) !!}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('physicalServers') ? 'is-invalid' : '' }}"
                                    name="physicalServers[]" id="physicalServers" multiple>
