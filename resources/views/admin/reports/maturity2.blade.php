  ...
  <div class="row">
    <div class="col-sm-6">
        <table class="table table-bordered table-striped table-hover">
            ...
            @endcanAccessAny
            @canAccessAny(\App\Models\MacroProcessus::class, \App\Models\Process::class, \App\Models\Activity::class, \App\Models\Operation::class, \App\Models\Actor::class, \App\Models\Information::class)
            <thead>
