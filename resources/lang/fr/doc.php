...
",
    ...
    'guide' => [
        ...
        'p2' => 'La cartographie du Système d’Information permet d’avoir une vue globale de l’ensemble des éléments qui constituent le système d’information pour d’obtenir une meilleure lisibilité, et donc un meilleur contrôle.',
        'p3' => 'L’élaboration d’une cartographie participe à la protection, à la défense et à la résilience du système d’information. C’est un outil indispensable à la maitrise de son système d’information (SI) et est une obligation pour les Opérateurs d’importance vitale (OIV) et qui s’intègre dans une démarche globale de gestion des risques.',
        'p4' => "Le guide « <a href='https://cyber.gouv.fr/publications/cartographie-du-systeme-dinformation' target='new'>Cartographie du système d’information – Guide d’élaboration en cinq étapes</a> » publié par l’ANSSI décrit dans la mise en place de cette démarche.",
        'title' => 'Guide',
    ],
];
