...
CREATE TABLE `buildings` (
  ...
  CONSTRAINT `buildings_building_id_foreign` FOREIGN KEY (`building_id`) REFERENCES `buildings` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `logical_flows` (
  ...
  `security_device_source_id` bigint(20) unsigned DEFAULT NULL,
  ...
  `security_device_dest_id` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE `physical_security_devices` (
  ...
  KEY `physical_security_devices_icon_id_index` (`icon_id`),
  ...
  CONSTRAINT `physical_security_devices_icon_id_foreign` FOREIGN KEY (`icon_id`) REFERENCES `documents` (`id`),
...
CREATE TABLE `security_devices` (
  ...
  `address_ip` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `security_devices_icon_id_index` (`icon_id`),
  CONSTRAINT `security_devices_icon_id_foreign` FOREIGN KEY (`icon_id`) REFERENCES `documents` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (201,'2025_03_26_133906_external_nullable',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (202,'2025_04_27_084635_add_icon_to_servers',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (203,'2025_04_27_123200_add_legal_basis',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (204,'2025_06_19_072710_add_databases_to_containers',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (205,'2025_06_28_155312_add_glpi_fields',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (206,'2025_07_01_065432_admin_user_fields',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (207,'2025_07_02_123433_rename_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (208,'2025_07_07_070846_add_admin_user_application',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (209,'2025_07_08_065626_add_references_to_logical_flows',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (210,'2025_07_17_145227_activities_bia',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (211,'2025_07_17_150249_create_activity_impact_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (212,'2025_08_23_111003_add_pra',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (213,'2025_08_27_135552_physical_logical_security_devices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (214,'2025_09_05_141822_add_external_ref_id_to_entities',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (215,'2025_09_21_134035_add_cluster_router',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (216,'2025_09_23_113715_add_user_login',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (217,'2025_09_29_193233_external_connected_entities_complement',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (218,'2025_10_02_205209_add_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (219,'2025_10_04_153231_add_attribut_on_fluxes',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (220,'2025_10_08_100558_more_buildings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (221,'2025_10_17_073218_add_cluster_logical_server',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (222,'2025_10_17_085635_add_fields_to_cluster',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (223,'2025_10_18_174616_add_cluster_physical_server',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (224,'2025_10_18_183453_add_cluster_router',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (225,'2025_10_21_104026_add_lawfullness',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (226,'2025_10_27_095802_add_link_applications_security_devices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (227,'2025_10_27_104704_add_fields_security_device',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (228,'2025_10_30_081134_change_active_nullable_on_lservers',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (229,'2025_11_01_123622_drop_unique_graphs_name_unique_on_graphs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (230,'2025_11_09_103559_add_network_switch_vlan',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (231,'2025_11_10_090632_add_subnetwork_link',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (232,'2025_11_17_110452_add_graph_class',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (233,'2025_11_21_123505_add_chain_to_logical_flow',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (234,'2025_11_24_152357_create_mercator_modules_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (235,'2025_11_30_123016_add_module_to_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (236,'2025_12_03_105527_add_ip_to_security_devices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (237,'2025_12_03_111641_add_security_device_to_logical_flows',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (238,'2025_12_04_135457_add_manage_module_role',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (239,'2026_01_16_114842_add_icon_to_databases',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (240,'2026_01_24_091900_add_information_flow_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (241,'2024_06_01_000001_create_oauth_device_codes_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (242,'2026_02_13_134714_add_cpe_to_application_modules',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (243,'2026_02_18_085500_add_type_color_to_physical_links',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (244,'2026_03_02_000001_upgrade_oauth_clients_uuid',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (245,'2026_03_03_184523_add_parent_man',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (246,'2026_03_05_114042_add_icon_to_physical_switches',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (247,'2026_03_11_134833_add_cluster_to_logical_flows',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (248,'2026_03_11_175208_add_information_information',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (249,'2026_03_22_121031_add_data_processing_fields',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (250,'2026_03_30_095429_add_document_permissions',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (251,'2026_05_08_182110_rename_domaine_ads_to_domaines',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (252,'2026_05_08_200000_rename_domaines_to_domains',4);
